        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <div className="relative">
              <input
                type="text"
                className="bg-navy-700 border border-gray-700 rounded-md pl-4 pr-10 py-2 w-full text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
            ...
            <select 
              className="mt-2 bg-navy-700 border border-gray-700 rounded-md px-4 py-2 w-full text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
